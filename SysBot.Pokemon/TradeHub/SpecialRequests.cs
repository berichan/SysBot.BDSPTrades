...
namespace SysBot.Pokemon
{
    public static class SpecialRequests
    {
        ...
        public static SpecialTradeType CheckItemRequest<T>(ref T pk, PokeRoutineExecutor<T> caller, PokeTradeDetail<T> detail, TradePartnerBS trainerTrading, SaveFile sav) where T : PKM, new()
        {
