...
namespace SysBot.Pokemon.ConsoleApp
{
    ...
    {
        private static string ConfigPath = Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), @"config.json"); // needed for systemctl service on linux to find config.json 
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        {
            var bot = new PokeBotState { Connection = new SwitchConnectionConfig { IP = "192.168.0.1", Port = 6000 }, InitialRoutine = PokeRoutineType.BDSPFlexTrade };
